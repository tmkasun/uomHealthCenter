...
<table width="1024px" height="474" bgcolor="#990033"align="center" border="1">
	  ...
	  <td align="left" valign="top">
	  	<table border="1" width="100%">
			<tr>
				...
				<td align="center"><input type="submit" value="Search" name="physiqueSearch" /></td>
			<tr>
			<tr>
			...
			<tr valign="top">
				...
				<td colspan="3" valign="middle" align="center">Colour Vision
					<input type="text" name="colourVision" size="20" />
	...
	<tr>
		...
		<td align="center">
		<input type="text" name="ears" size="12" />
		...
		<td align="center">
		<input type="text" name="nose" size="12" />
		...
		<td align="center">
		<input type="text" name="mouth" size="12" />
		...
		<td align="center">
		<input type="text" name="throat" size="12" />
		...
		<td align="center">
		<input type="text" name="tonsils" size="12" />
		...
		<td align="center">
		<input type="text" name="abdomen" size="12" />
		...
		<td align="center">
		<input type="text" name="hernial_orifices" size="12" />
		...
		<td align="center">
		<input type="text" name="genitalia" size="12" />
		...
		<td align="center">
		<input type="text" name="anus" size="12" />
