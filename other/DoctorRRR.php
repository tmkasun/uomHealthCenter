					...
					<table border="1" width="97%">
	  									...
	  									<tr>
											<td height="19">
												<label><font color="#0000FF" size="+1">Investigations</font><br />
        											<textarea name="textarea4" id="textarea4" rows="6" cols="40"></textarea>
     											</label>
											</td>
										</tr>
									</table>
    					...
    					<tr>
							...
							<label>
									...
									<div>
										<tr height>
											...
											<td bgcolor="#FFFFFF" rowspan="2">
												...
												<a href="Doctor_treatment.php" style="color:#0066CC; font-weight:bold">
      						...
      						<td>
	  							<p><font color="#0000FF" size="+1">Treatment</font>
								</p>
      							<p>
        							<label>
        								<textarea name="textarea5" id="textarea5" rows="5" cols="45">
										</textarea>
        							</label>
       							</p>
							</td>
