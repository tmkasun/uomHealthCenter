...
if($_SESSION["USERID"]){
	...
	$username = $_SESSION["USERID"];//get username grom form posting
		...
		//block tring after 3 attempt end--
			...
			function ajax_return(){
				...
				if(loginstatus<0){ // wrong password
					...
					$("#fit11").fadeOut("slow");
					setTimeout(function(){$("#myusername").effect( "drop",{direction: "right"}, 500);},200);
					...
					case 1:
						...
						setTimeout(function(){window.location.href = "/pages/admin/adminPanel.php";},1000);
						
						break;

					case 2:
						setTimeout(function(){window.location.href = '/pages/doctor/new_doctor.php';},1000);
					...
					case 4:
						setTimeout(function(){window.location.href = '/pages/mlt/mlt_page.php';},1000);
						
						break;

					case 5:
						setTimeout(function(){window.location.href = '/pages/dentist/dentist_page.php';},1000);
...
<body id="body_first"
	...
	<a
		style="position: absolute; bottom: 0px; margin-left: auto; color: #898989; font-size: 10pt; margin-left: auto;">
		Developed by Faculty Of Information Technology- University of Moratuwa
