...
var url="DisplayResult.php?p=6&q=" + str;
//alert(url);
...
<table border="0" width="97%">
						...
						<tr>
							...
							<tr>
								...
								<td><input type="text" name="fbs" size="10"/><font color='#000000' face='Tahoma' size='2'>
								mg/dl </font></td>
							...
							<td colspan="2">
								...
								<td align="right">
									<input type="submit" name="fbsFormSubmit" value="Submit"/>
								</td>
							</tr>
