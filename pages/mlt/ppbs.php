...
var url="DisplayResult.php?p=8&q=" + str;
//alert(url);
...
<table border="0" width="97%">
						...
						<tr>
							...
							<tr>
								...
								<td><input type="text" name="ppbs" size="10"/><font color='#000000' face='Tahoma' size='2'>
								mg/dl </font></td>
							...
							<td colspan="2">
								...
								<td align="right">
									<input type="submit" name="ppbsFormSubmit" value="Submit"/>
								</td>
							</tr>
