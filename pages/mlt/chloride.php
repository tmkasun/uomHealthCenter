...
var url="DisplayResult.php?p=3&q=" + str;
//alert(url);
...
<table border="0" width="97%">
						...
						<tr>
							...
							<tr>
								...
								<td><input type="text" name="chloride" size="10"/><font color='#000000' face='Tahoma' size='2'>
								m mol/l </font></td>
							...
							<td colspan="2">
								...
								<td align="right">
									<input type="submit" name="chlorideFormSubmit" value="Submit"/>
								</td>
							</tr>
