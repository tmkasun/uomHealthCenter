...
var url="DisplayResult.php?p=4&q=" + str;
//alert(url);
...
<form name="bgloucoseFastingform" action="UpdateInvestigation.php" method="post">
<div>
<table border="0" width="97%">
						...
						<tr>
							...
							<tr>
								...
								<td><input type="text" name="bglucosefasting" size="10"/><font color='#000000' face='Tahoma' size='2'> mg/dl</font></td>
							...
							<td colspan="2">
								...
								<td  align="right">
									<input type="submit" name="bglucoseFastingsubmit" value="Submit"/>
								</td>
							</tr>
