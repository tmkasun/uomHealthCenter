...
<meta name="keywords"
	content="itfac,mrt.ac.lk,student,student information,kbsoft,kasun,moratuwa,lanka students,phone numbers,telephone,information" />
<meta name="author" content="kasun thennakoon" />
<meta name="description"
	content="University information system for ITFA.mrt.ac.lk b11 students" />
<!-- meta charset="UTF-8"/ -->
...
<div id="notFound"
	style="position: relative; margin: 0%; float: left; margin-left: 25%; width: 50%; height: auto; background: rgba(0, 0, 0, 0.8);">
	<div
		style="position: relative; float: left; margin-left: 25%; margin-right: 25%;">
		<a style="background-color: yellow; text-align: center;">Sorry </a>
		<?php echo $query  ?>
		<a style="background-color: yellow; text-align: center;"> Not found in
			this database :(<br /> please try again
		</a>
...
<div>
	...
	<table class="round_edges" id="result_table" border="0"
		style="background-color: #330036; position: relative; top: 0px; left: 5%; width: 90%; opacity: 1.0;">
		<tr>
			<th
				style="color: #2E0B00; background-color: #BAEFF7; box-shadow: 0px 0px 50px 10px #4EB7B4 inset;">Registration
				Number</th>
			<th
				style="color: #2E0B00; background-color: #BAF7C9; box-shadow: 0px 0px 10px 10px #4EB7B4 inset;">name</th>
			<th
				style="color: #2E0B00; background-color: #F7EEBA; box-shadow: 0px 0px 10px 10px #4EB7B4 inset;">Gender</th>
		</tr>
		<?php
		//$_SESSION["first"] = true;
		$count  =0;
     ...
     ?>
		...
		<tr onclick="clk_admin(this)" id="<?php echo $row["StudentID"]; ?>"
			onmouseover="mo(this)" onmouseout="moo(this)">

			<!-- end -->


			<td style="background-color: #BAEFF7;"><?php echo $row["StudentID"]; ?>
			</td>
			<?php 
