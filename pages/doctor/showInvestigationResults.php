...
if($investigationName=="FBCESR" || $investigationName=="FBC" || $investigationName=="ESR" )
{
...
else if($investigationName=="FBS")
{

$query6="SELECT * FROM fbs  WHERE fbs.fbs_treatment_id=".$treatmentID;

mysql_select_db($dbdatabase, $con);
$result_fbs = mysql_query($query6);

$row_fbs = mysql_fetch_array($result_fbs);
...
<table border='0' width='97%'>
						<tr><form> 
							...
							<td width='20%'>
								...
								<input type='text' name='treatmentId' value='".$row_fbs['fbs_treatment_id']."' >
							...
							<td width='29%'>
							<input type='text' name='reportedon' size='20' value='".$row_fbs['fbs_reported_on']."'  />
							</td>
						...
						<tr>
							...
							<td width='20%'>
								<input type='text' name='regId' value='".$row_fbs['fbs_reg_number']."' />
							</td>
							<td width='20%'><font color='#000000' face='Tahoma' size='2'>
							Received On:</font>
							</td>
							<td width='29%'>
							<input type='text' name='treatmentDate' value='".$row_fbs['fbs_received_on']."'  />
						...
						<tr>
							...
							<td>
								<input type='text' name='gender' value='".$row_fbs['fbs_sex']."' />
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Reference Doctor:</font>
							</td>
							<td>
							<input type='text' name='refDoctor' value='".$row_fbs['fbs_ref_doctor']."' />
							</td>
						...
						<tr>
							...
							<td>
								<input type='text' name='investigationId' value='".$row_fbs['fbs_investigation_id']."' />
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Specimen</font>
							</td>
							<td>
							<input type='text' name='specimen' value='".$row_fbs['fbs_specimen']."' />
							</td>
							...
							<table border='0' width='97%'>
							<tr>
							<td colspan='4' align='center'><font color='#000000' face='Tahoma' size='2'><b>Fasting Blood Sugar</b></font></td>
							</tr>
							</table>
							<table border='1'>
							<tr>
							...
							<tr>
								<td><font color='#000000' face='Tahoma' size='2'><b>Fasting Blood Sugar</b></font></td>
								<td><input type='text' name='fbs' value='".$row_fbs['fbs']."'  size='10'/><font color='#000000' face='Tahoma' size='2'>
								mg/dl </font></td>
								<td><font color='#000000' face='Tahoma' size='2'> 70 - 110 mg/dl</font> </td>
							</tr>
...
else if($investigationName=="RBS")
{


$query7="SELECT * FROM rbs  WHERE rbs.rbs_treatment_id=".$treatmentID;

mysql_select_db($dbdatabase, $con);
$result_rbs = mysql_query($query7);

$row_rbs = mysql_fetch_array($result_rbs);
...
<table border='0' width='97%'>
						<tr><form> 
							...
							<td width='20%'>
								...
								<input type='text' name='treatmentId' value='".$row_rbs['rbs_treatment_id']."'>
							...
							<td width='29%'>
							<input type='text' name='reportedon' size='20' value='".$row_rbs['rbs_reportedon']."' />
							</td>
						...
						<tr>
							...
							<td width='20%'>
								<input type='text' name='regId' value='".$row_rbs['rbs_reg_number']."'/>
							</td>
							<td width='20%'><font color='#000000' face='Tahoma' size='2'>
							Received On:</font>
							</td>
							<td width='29%'>
							<input type='text' name='treatmentDate' value='".$row_rbs['rbs_receivedon']."' />
						...
						<tr>
							...
							<td>
								<input type='text' name='gender' value='".$row_rbs['rbs_sex']."'/>
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Reference Doctor:</font>
							</td>
							<td>
							<input type='text' name='refDoctor' value='".$row_rbs['rbs_ref_doctor']."'/>
							</td>
						...
						<tr>
							...
							<td>
								<input type='text' name='investigationId' value='".$row_rbs['rbs_investigationid']."'/>
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Specimen</font>
							</td>
							<td>
							<input type='text' name='specimen' value='".$row_rbs['  	rbs_specimen']."'/>
							</td>
							...
							<tr>
								...
								<td><input type='text' name='rbs' size='10' value='".$row_rbs['rbs']."'/><font color='#000000' face='Tahoma' size='2'>
								mg/dl </font></td>
...
else if($investigationName=="PPBS")
{

$query8="SELECT * FROM ppbs  WHERE ppbs.ppbs_treatment_id=".$treatmentID;

mysql_select_db($dbdatabase, $con);
$result_ppbs = mysql_query($query8);

$row_ppbs = mysql_fetch_array($result_ppbs);
...
<table border='0' width='97%'>
						<tr><form> 
							...
							<td width='20%'>
								...
								<input type='text' name='treatmentId' value='".$row_ppbs['ppbs_treatment_id']."' >
							...
							<td width='29%'>
							<input type='text' name='reportedon' size='20' value='".$row_ppbs['ppbs_reported_on']."'  />
							</td>
						...
						<tr>
							...
							<td width='20%'>
								<input type='text' name='regId' value='".$row_ppbs['ppbs_regNumber']."' />
							</td>
							<td width='20%'><font color='#000000' face='Tahoma' size='2'>
							Received On:</font>
							</td>
							<td width='29%'> 
							<input type='text' name='treatmentDate' value='".$row_ppbs['ppbs_received_on']."'  />
						...
						<tr>
							...
							<td>
								...
								value='".$row_ppbs['ppbs_sex']."' />
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Reference Doctor:</font>
							</td>
							<td>
							<input type='text' name='refDoctor' value='".$row_ppbs['ppbs_ref_doctor']."' />
							</td>
						...
						<tr>
							...
							<td>
								<input type='text' name='investigationId' value='".$row_ppbs['ppbs_investigation_id']."' />
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Specimen</font>
							</td>
							<td>
							<input type='text' name='specimen' value='BLOOD' value='".$row_ppbs['ppbs_specimen']."' />
							</td>
							...
							<table border='0' width='97%'>
							<tr>
							<td colspan='4' align='center'><font color='#000000' face='Tahoma' size='2'><b>P.P.B.S</b></font></td>
							</tr>
							</table>
							<table border='1'>
							<tr>
							...
							<tr>
								<td><font color='#000000' face='Tahoma' size='2'><b>P.P.B.S</b></font></td>
								<td><input type='text' name='ppbs' size='10' value='".$row_ppbs['ppbs']."' /><font color='#000000' face='Tahoma' size='2'>
								mg/dl </font></td>
								<td><font color='#000000' face='Tahoma' size='2'>70.0-110.0 mg/dl</font> </td>
							</tr>
...
else if($investigationName=="UFR")
{

$query9="SELECT * FROM ufr WHERE ufr.treatment_id=".$treatmentID;

mysql_select_db($dbdatabase, $con);
$result_ufr = mysql_query($query9);

$row_ufr = mysql_fetch_array($result_ufr);
...
<table border='0' width='97%'>
						<tr><form> 
							...
							<td width='20%'>
								...
								<input type='text' name='treatmentId' value='".$row_ufr['treatment_id']."' >
							...
							<td width='29%'>
							<input type='text' name='reportedon' size='20' value='".$row_ufr['ufr_reported_on']."'/>
							</td>
						...
						<tr>
							...
							<td width='20%'>
								<input type='text' name='regId' value='".$row_ufr['ufr_patient_id']."'/>
							</td>
							<td width='20%'><font color='#000000' face='Tahoma' size='2'>
							Received On:</font>
							</td>
							<td width='29%'>
							<input type='text' name='treatmentDate'  value='".$row_ufr['ufr_received_on']."'/>
						...
						<tr>
							...
							<td>
								<input type='text' name='gender' value='".$row_ufr['ufr_patient_gender']."'/>
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Reference Doctor:</font>
							</td>
							<td>
							<input type='text' name='refDoctor' value='".$row_ufr['ufr_ref_doctor']."'/>
							</td>
						...
						<tr>
							...
							<td>
								<input type='text' name='investigationId' value='".$row_ufr['ufr_investigation_id']."'/>
							</td>
							<td><font color='#000000' face='Tahoma' size='2'>
							Specimen</font>
							</td>
							<td>
							<input type='text' name='specimen' value='".$row_ufr['ufr_specimen']."'/>
							</td>
							...
							<table border='0' width='97%'>
							<tr>
							<td colspan='4' align='center'><font color='#000000' face='Tahoma' size='2'><b>URINE ROUTINE AND MICROSCOPY</b></font></td>
							</tr>
							</table>
							<table border='1'>
							<tr>
							<td width='296'><font color='#000000' face='Tahoma' size='2'>TEST</font></td>
							<td width='375'><font color='#000000' face='Tahoma' size='2'>RESULT</font></td>
							
							
							</tr>
							<tr>
								<td colspan='2'><font color='#000000' face='Tahoma' size='2'><b>URINE ROUTINE AND MICROSCOPY</b></font></td>
								
							</tr>
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Colour</font></td>
							<td><input type='text' size='58' name='colour' value='".$row_ufr['Colour']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Apperance</font></td>
							<td><input type='text' size='58' name='apperance' value='".$row_ufr['Apperance']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Specific Gravity</font></td>
							<td><input type='text' size='58' name='specificgravity' value='".$row_ufr['SpecificGravity']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>PH</font></td>
							<td><input type='text' size='58' name='ph' value='".$row_ufr['PH']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Protein</font></td>
							<td><input type='text' size='58' name='protien' value='".$row_ufr['Protein']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Sugar</font></td>
							<td><input type='text' size='58' name='sugar' value='".$row_ufr['Sugar']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Ketone</font></td>
							<td><input type='text' size='58' name='ketone' value='".$row_ufr['Ketone']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Urobilinogen</font></td>
							<td><input type='text' size='58' name='urobilinogen' value='".$row_ufr['Urobilinogen']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Bilirubin</font></td>
							<td><input type='text' size='58' name='bilirubin' value='".$row_ufr['Bilirubin']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Nitrile</font></td>
							<td><input type='text' size='58' name='nitrile' value='".$row_ufr['Nitrile']."'/></td>
							</tr>
							
							<tr>
							<td colspan='2'><font color='#000000' face='Tahoma' size='2'><b>MICROSCOPY</b></font></td>
							
							</tr>
							
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Pus Cells</font></td>
							<td><input type='text' size='58' name='puscells' value='".$row_ufr['PusCells']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Red Blood Cells</font></td>
							<td><input type='text' size='58' name='redbloodcells' value='".$row_ufr['RedBloodCells']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Epithelial Cells</font></td>
							<td><input type='text' size='58' name='epithelialcells' value='".$row_ufr['EpithelialCells']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Crystals</font></td>
							<td><input type='text' size='58' name='crystals' value='".$row_ufr['Crystals']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Casts</font></td>
							<td><input type='text' size='58' name='casts' value='".$row_ufr['Casts']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Organisms</font></td>
							<td><input type='text' size='58' name='organisms' value='".$row_ufr['Organisms']."'/></td>
							</tr>
							
							<tr>
							<td><font color='#000000' face='Tahoma' size='2'>Others</font></td>
							<td><input type='text' size='58' name='others' value='".$row_ufr['Others']."'/></td>
							</tr>
