						...
						<div>
							<table border="0" width="100%" cellpadding="2" cellspacing="0">
								<form autocomplete="off" enctype="multipart/form-data"
									method="post" action="addPersonalRecodes.php"
								...
								<tr>
									...
									<td colspan="2"><font color='#000000' face='Tahoma' size='2'>Full
											Name:</font><br />
									</td>
								...
								<tr>
									<td>
										<div>
											<input type="text" size="15" name="indexNo" id="indexNo" /> <label
												class="error"> </label>
										</div>
									</td>
									<td colspan="2">
										<div>
											<input type="text" size="47" name="fullName" id="fullName" />
								...
								<tr>
									...
									<input type="hidden" name="MAX_FILE_SIZE" value="16194304" />
								...
								<tr valign="bottom">
									<td><font color='#000000' face='Tahoma' size='2'>Faculty: </font><br />

									</td>
									<td><font color='#000000' face='Tahoma' size='2'>Religion: </font><br />

									</td>

									<td><font color='#000000' face='Tahoma' size='2'>Nationality: </font><br />

									</td>
								</tr>
								<tr>
									<td><select name="faculty" id="faculty"
										style="font: Tahoma; size: 2;">
								...
								<tr valign="top">
									<td><br /> <font color='#000000' face='Tahoma' size='2'>Marital
											Status </font><br />
									</td>
									<td><br /> <font color='#000000' face='Tahoma' size='2'>Gender
									</font><br />
									</td>
									<td><br /> <font color='#000000' face='Tahoma' size='2'>Date of
											Birth </font><br />
									</td>
								</tr>
								<tr>
									<td><input name="mstatus" type="radio" value="Single"
										id="mstatus" /> <font color='#000000' face='Tahoma' size='2'>Single</font>
										<input name="mstatus" type="radio" value="Married"
										id="mstatus" /> <font color='#000000' face='Tahoma' size='2'>Married</font>

									</td>
									<td><input name="gender" type="radio" value="male" id="gender" /><font
										color='#000000' face='Tahoma' size='2'>Male</font> <input
										name="gender" type="radio" value="female" id="gender" /> <font
										color='#000000' face='Tahoma' size='2'>Female</font>
									</td>
									<td><input type="text" size="12" value="5/18/1985" name="dob"
										id="dob" />
									</td>
								...
								<td><font color='#000000' face='Tahoma' size='2'>Current
										Address:</font><br />
								</td>
								<td><font color='#000000' face='Tahoma' size='2'>Permanent
										Address:</font><br />
								</td>
								</tr>
								<tr>
									<td><textarea cols="20" rows="5" name="currentAdd"
											id="currentAdd">
					</textarea>
									</td>
									<td><textarea cols="20" rows="5" name="permenentAdd"
											id="permenentAdd">
					</textarea>
									</td>
								...
								<tr>
									...
									<td colspan="2">
										...
										<div
											style="font: Arial, Helvetica, sans-serif; color: #000099; float: right;">
