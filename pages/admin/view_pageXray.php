...
<html>
<head>
<title>Admin Panel - View Clinical Information</title>
	...
	<tr valign="top">
		...
		<table border="0" width="100%">
			...
			<tr>
				...
				<td width="68%"><input type="text" size="58" disabled="disabled" style="font:Arial, Helvetica, sans-serif; color:#0000FF;" name="heart" value="<?PHP echo $row1['HEART'] ?>"/></td>
			</tr>
			<tr>
